    ...
    public void onBindViewHolder(@NonNull final MessageViewHolder messageViewHolder, final int position) {
        ...
        usersRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.hasChild("image")){
                    ...
                    Picasso.get().load(receiverProfileImage).placeholder(R.drawable.icon_male).into(messageViewHolder.receiverProfileImage);
                }
            }
        ...
        if (fromMessageType.equals("text")){
            ...
            if (fromUserID.equals(messageSenderId)){
                ...
                Picasso.get().load("https://firebasestorage.googleapis.com/v0/b/psikologiku-f2d2b.appspot.com/o/Image%20Files%2FFiles-icon.png?alt=media&token=62482665-30b0-4c4c-8701-b7c86f28b6bb")
